...
vim.api.nvim_create_autocmd('LspAttach', {
  ...
  callback = function(event)
    ...
    map('n', '<leader>sS', require('telescope.builtin').lsp_dynamic_workspace_symbols, 'Search Workspace Symbols')
    ...
    -- 光标悬停时高亮文档中的所有引用
    if client and client.supports_method(vim.lsp.protocol.Methods.textDocument_documentHighlight) then
      local highlight_augroup = vim.api.nvim_create_augroup('lsp-highlight-references', { clear = false })
